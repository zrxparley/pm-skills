...
### Input
Your task is to analyze user feedback data for **{user_input}** and identify market segments with associated sentiment insights.
...
- What this segment loves about {user_input}
...
- How well {user_input} serves this segment's needs
