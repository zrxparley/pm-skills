...
### Input
Your task is to identify and analyze potential customer segments for **{user_input}**.
...
1. **Market Exploration**: Consider the full addressable market for {user_input}
