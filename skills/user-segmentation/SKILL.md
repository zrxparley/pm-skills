...
### Input
Your task is to segment users for **{user_input}** based on behavior, jobs-to-be-done, and unmet needs.
...
- How this segment uses {user_input} (primary use cases, frequency, depth)
...
**Current Product Fit**
- How well {user_input} currently serves this segment
