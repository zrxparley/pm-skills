...
Based on the following value proposition(s) for {user_input}, develop comprehensive value proposition statements that can be used across marketing, sales, and onboarding contexts.
