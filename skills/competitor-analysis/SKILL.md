...
### Input
Your task is to analyze the competitive landscape for **{user_input}** in the **[market/industry segment]** (if specified).
...
1. **Market Scoping**: Define the market, industry, and addressable customer base for {user_input}
...
5. **Differentiation Mapping**: Identify gaps, overlaps, and opportunities for {user_input} to differentiate
...
- Recommended competitive positioning for {user_input}
